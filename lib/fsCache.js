...
//
// Any file starting with "._" is a macOS AppleDouble resource-fork companion
// file (created automatically by macOS on non-HFS+/APFS volumes, e.g. network
// shares/external drives). These are never real media and are always
// excluded here — so folders/galleries and media-listing endpoints never try
// to render them.
